 ...
 * @author Scott Violet
 */
public class VRMLComponentsCellRenderer extends JLabel implements TreeCellRenderer
{
    ...
    transient protected Icon materialIcon;
     ...
     * UIManager.
     */
    public VRMLComponentsCellRenderer() {
        //TODO: set more Icons
        setLeafIcon(DefaultLookup.getIcon(this, ui, "Tree.leafIcon"));
        setAppearanceIcon(new ImageIcon("icons/appearance.gif"));
    ...
    public void setShapeIcon(Icon newIcon) {
        shapeIcon = newIcon;
    }
    ...
    public Icon  getAppearanceIcon() {
        return appearanceIcon;
    }

    public void setBoxIcon(Icon newIcon) {
        boxIcon = newIcon;
    }

    public Icon  getBoxIcon() {
        return boxIcon;
    }

    public void setMaterialIcon(Icon newIcon) {
        materialIcon = newIcon;
    }
    ...
    public Component getTreeCellRendererComponent(JTree tree, Object value,
        ...
        Icon icon = null;
        //TODO: Icons differentiation
        if ("Shape".equals(value.toString())) {
            icon = getShapeIcon();
        } else if("material".equals(value.toString())){
